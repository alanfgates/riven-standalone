 ...
 * IpAddressListener
 */
public class TestRemoteMetaStoreIpAddress {
  ...
  public void startServer() throws Exception {
    ...
    if (isServerStarted) {
      Assert.assertNotNull("Unable to connect to the MetaStore server", msc);
      return;
    }

    int port = MetaStoreUtils.findFreePort();
    System.out.println("Starting MetaStore Server on port " + port);
    System.setProperty(ConfVars.EVENT_LISTENERS.varname,
