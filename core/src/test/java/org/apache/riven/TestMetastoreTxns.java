...
import org.apache.riven.txn.ValidReadTxnList;
...
import org.apache.riven.txn.TxnDbUtil;
...
/**
 * Unit tests txns for {@link MetaStoreClient}.  For now this just has
 ...
 * service.
 */
public class TestMetastoreTxns {
  static final private Logger LOG = LoggerFactory.getLogger(TestMetastoreTxns.class);
