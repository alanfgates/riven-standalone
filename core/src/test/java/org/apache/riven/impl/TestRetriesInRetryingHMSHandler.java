...
public class TestRetriesInRetryingHMSHandler {
  ...
  public static void setup() throws IOException {
    ...
    MetastoreConf.setLongVar(conf, MetastoreConf.ConfVars.HMSHANDLERATTEMPTS, RETRY_ATTEMPTS);
    MetastoreConf.setTimeVar(conf, MetastoreConf.ConfVars.HMSHANDLERINTERVAL, 10, TimeUnit.MILLISECONDS);
    MetastoreConf.setBoolVar(conf, MetastoreConf.ConfVars.HMSHANDLERFORCERELOADCONF, false);
