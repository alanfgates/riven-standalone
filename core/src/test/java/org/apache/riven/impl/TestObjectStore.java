...
public class TestObjectStore {
  ...
  public void testNotificationOps() throws InterruptedException {
    ...
    // TODO RIVEN Hack for now to get out of moving the event stuff before the stores.  Replace
    // this once I moev the event stuff.
    NotificationEvent event = new NotificationEvent(0, 0, "CREATE_DATABASE", "");
    /*
