...
import org.apache.riven.impl.AggregateStatsCache;
import org.apache.riven.impl.AggregateStatsCache.AggrColStats;
import org.apache.riven.impl.AggregateStatsCache.Key;
...
public class TestAggregateStatsCache {
  ...
  public void setUp() {
    ...
    MetastoreConf.setDoubleVar(
        conf, ConfVars.AGGREGATE_STATS_CACHE_FPP, FALSE_POSITIVE_PROBABILITY);
    MetastoreConf.setDoubleVar(conf, ConfVars.AGGREGATE_STATS_CACHE_MAX_VARIANCE,
        MAX_VARIANCE);
