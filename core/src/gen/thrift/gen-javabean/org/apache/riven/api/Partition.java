...
public class Partition implements org.apache.thrift.TBase<Partition, Partition._Fields>, java.io.Serializable, Cloneable, Comparable<Partition> {
    ...
    Map<String,String> parameters)
  {
    this();
    this.values = values;
    this.dbName = org.apache.riven.utils.StringUtils.intern(dbName);
    this.tableName = org.apache.riven.utils.StringUtils.intern(tableName);
  ...
  public Partition(Partition other) {
    ...
    if (other.isSetDbName()) {
      this.dbName = org.apache.riven.utils.StringUtils.intern(other.dbName);
    }
    if (other.isSetTableName()) {
      this.tableName = org.apache.riven.utils.StringUtils.intern(other.tableName);
    }
