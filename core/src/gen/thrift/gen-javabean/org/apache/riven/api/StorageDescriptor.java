...
public class StorageDescriptor implements org.apache.thrift.TBase<StorageDescriptor, StorageDescriptor._Fields>, java.io.Serializable, Cloneable, Comparable<StorageDescriptor> {
    ...
    Map<String,String> parameters)
  {
    this();
    this.cols = cols;
    this.location = org.apache.riven.utils.StringUtils.intern(location);
    this.inputFormat = org.apache.riven.utils.StringUtils.intern(inputFormat);
    this.outputFormat = org.apache.riven.utils.StringUtils.intern(outputFormat);
    this.compressed = compressed;
    setCompressedIsSet(true);
    this.numBuckets = numBuckets;
    setNumBucketsIsSet(true);
    this.serdeInfo = serdeInfo;
    this.bucketCols = org.apache.riven.utils.StringUtils.intern(bucketCols);
    this.sortCols = sortCols;
    this.parameters = org.apache.riven.utils.StringUtils.intern(parameters);
  }
  ...
  public StorageDescriptor(StorageDescriptor other) {
    ...
    if (other.isSetLocation()) {
      this.location = org.apache.riven.utils.StringUtils.intern(other.location);
    }
    if (other.isSetInputFormat()) {
      this.inputFormat = org.apache.riven.utils.StringUtils.intern(other.inputFormat);
    }
    if (other.isSetOutputFormat()) {
      this.outputFormat = org.apache.riven.utils.StringUtils.intern(other.outputFormat);
    }
