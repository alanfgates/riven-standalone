...
public class FieldSchema implements org.apache.thrift.TBase<FieldSchema, FieldSchema._Fields>, java.io.Serializable, Cloneable, Comparable<FieldSchema> {
  ...
  {
    this();
    this.name = org.apache.riven.utils.StringUtils.intern(name);
    this.type = org.apache.riven.utils.StringUtils.intern(type);
    this.comment = org.apache.riven.utils.StringUtils.intern(comment);
  }
  ...
  public FieldSchema(FieldSchema other) {
    if (other.isSetName()) {
      this.name = org.apache.riven.utils.StringUtils.intern(other.name);
    }
    if (other.isSetType()) {
      this.type = org.apache.riven.utils.StringUtils.intern(other.type);
    }
    if (other.isSetComment()) {
      this.comment = org.apache.riven.utils.StringUtils.intern(other.comment);
    }
  }
