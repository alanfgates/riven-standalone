 ...
 *  @generated
 */
#ifndef metastore_CONSTANTS_H
#define metastore_CONSTANTS_H

#include "metastore_types.h"

namespace Apache { namespace Riven {
...
extern const metastoreConstants g_metastore_constants;
