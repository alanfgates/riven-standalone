...
public class LogUtils {
  ...
  public static String initHiveLog4j()
    ...
    return initHiveLog4jCommon(MetastoreConf.ConfVars.LOG4J_FILE);
  }

  private static String initHiveLog4jCommon(MetastoreConf.ConfVars confVarName)
      throws LogInitializationException {
  ...
  @VisibleForTesting
  public static String initHiveLog4jCommon(Configuration conf, MetastoreConf.ConfVars confVarName)
    throws LogInitializationException {
  ...
  public static boolean checkAndSetAsyncLogging(final Configuration conf) {
    final boolean asyncLogging = MetastoreConf.getBoolVar(conf, MetastoreConf.ConfVars.ASYNC_LOG_ENABLED);
    if (asyncLogging) {
  ...
  private static String initHiveLog4jDefault(
    Configuration conf, String logMessage, MetastoreConf.ConfVars confVarName)
    throws LogInitializationException {
    URL hive_l4j = null;
    switch (confVarName) {
      case LOG4J_FILE:
  ...
  private static void logConfigLocation(Configuration conf) throws LogInitializationException {
