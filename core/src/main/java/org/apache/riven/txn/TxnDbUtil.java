...
public final class TxnDbUtil {
  ...
  public static void setConfValues(Configuration conf) {
    // hive.txn.manager isn't used by the metastore.  But some classes that use this class may
    // need it set.
    MetastoreConf.setVar(conf, ConfVars.HIVE_TXN_MANAGER, TXN_MANAGER);
    // Concurrency is always true in the metastore, but again other classes may need this.
  ...
  public static void cleanDb() throws Exception {
    ...
    throw new RuntimeException("Failed to cleanup transaction db");
  }
