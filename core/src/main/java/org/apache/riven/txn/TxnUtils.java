...
public class TxnUtils {
  ...
  /**
   * Transform a {@link org.apache.riven.api.GetOpenTxnsResponse} to a
   * {@link ValidTxnList}.  This assumes that the caller intends to
  ...
  /**
   * Transform a {@link org.apache.riven.api.GetOpenTxnsInfoResponse} to a
   * {@link ValidTxnList}.  This assumes that the caller intends to
  ...
  public static boolean isAcidTable(Table table) {
    ...
    String tableIsTransactional = parameters.get(metastoreConstants.TABLE_IS_TRANSACTIONAL);
