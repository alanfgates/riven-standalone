...
public class StatsSetupConst {
  ...
  public enum StatDB {
    ...
    custom {
      @Override
      public String getPublisher(Configuration conf) {
        return MetastoreConf.getVar(conf, MetastoreConf.ConfVars.STATS_DEFAULT_PUBLISHER); }
      @Override
      public String getAggregator(Configuration conf) {
        return MetastoreConf.getVar(conf,  MetastoreConf.ConfVars.STATS_DEFAULT_AGGREGATOR); }
    };
