 ...
 */
package org.apache.riven.parser;
...
public class ExpressionTree {
  ...
  public static class TreeNode {
    ...
    public void generateJDOFilter(Configuration conf, Table table,
      ...
      if (lhs != null) {
        ...
        lhs.generateJDOFilter(conf, table, params, filterBuilder);
        ...
        if (rhs != null) {
          ...
          rhs.generateJDOFilter(conf, table, params, filterBuilder);
        }
        filterBuilder.append (") ");
      }
    }
  ...
  public static class LeafNode extends TreeNode {
    ...
    private void generateJDOFilterOverTables(Map<String, Object> params,
        FilterBuilder filterBuilder) throws MetaException {
      if (keyName.equals(metastoreConstants.HIVE_FILTER_FIELD_OWNER)) {
        keyName = "this.owner";
      } else if (keyName.equals(metastoreConstants.HIVE_FILTER_FIELD_LAST_ACCESS)) {
      ...
      } else if (keyName.startsWith(metastoreConstants.HIVE_FILTER_FIELD_PARAMS)) {
        ...
        String paramKeyName = keyName.substring(metastoreConstants.HIVE_FILTER_FIELD_PARAMS.length());
    ...
    private String getJdoFilterPushdownParam(Table table, int partColIndex,
      ...
      if (value instanceof Date) {
        val = MSConstants.PARTITION_DATE_FORMAT.get().format((Date)value);
      }
