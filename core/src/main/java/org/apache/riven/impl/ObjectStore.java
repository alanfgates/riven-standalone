...
import org.apache.riven.impl.MetaStoreDirectSql.SqlFilterForPushdown;
...
import org.apache.riven.api.CurrentNotificationEventId;
...
import org.apache.riven.api.HiveObjectPrivilege;
import org.apache.riven.api.HiveObjectRef;
import org.apache.riven.api.HiveObjectType;
import org.apache.riven.api.Index;
import org.apache.riven.api.InvalidInputException;
...
import org.apache.riven.api.NotificationEventRequest;
import org.apache.riven.api.NotificationEventResponse;
...
import org.apache.riven.api.PrivilegeBag;
...
import org.apache.riven.api.RolePrincipalGrant;
import org.apache.riven.api.SQLForeignKey;
import org.apache.riven.api.SQLNotNullConstraint;
import org.apache.riven.api.SQLPrimaryKey;
import org.apache.riven.api.SQLUniqueConstraint;
...
import org.apache.riven.api.TableMeta;
import org.apache.riven.api.Type;
import org.apache.riven.api.UnknownDBException;
import org.apache.riven.api.UnknownPartitionException;
...
import org.apache.riven.model.MColumnDescriptor;
import org.apache.riven.model.MConstraint;
import org.apache.riven.model.MDBPrivilege;
import org.apache.riven.model.MDatabase;
import org.apache.riven.model.MDelegationToken;
import org.apache.riven.model.MFieldSchema;
import org.apache.riven.model.MFunction;
import org.apache.riven.model.MGlobalPrivilege;
import org.apache.riven.model.MIndex;
import org.apache.riven.model.MMasterKey;
import org.apache.riven.model.MNotificationLog;
import org.apache.riven.model.MNotificationNextId;
import org.apache.riven.model.MOrder;
import org.apache.riven.model.MPartition;
import org.apache.riven.model.MPartitionColumnPrivilege;
import org.apache.riven.model.MPartitionColumnStatistics;
import org.apache.riven.model.MPartitionEvent;
import org.apache.riven.model.MPartitionPrivilege;
import org.apache.riven.model.MResourceUri;
import org.apache.riven.model.MRole;
import org.apache.riven.model.MRoleMap;
import org.apache.riven.model.MSerDeInfo;
import org.apache.riven.model.MStorageDescriptor;
import org.apache.riven.model.MStringList;
import org.apache.riven.model.MTable;
import org.apache.riven.model.MTableColumnPrivilege;
import org.apache.riven.model.MTableColumnStatistics;
import org.apache.riven.model.MTablePrivilege;
import org.apache.riven.model.MType;
import org.apache.riven.model.MVersionTable;
import org.apache.riven.model.MMetastoreDBProperties;
import org.apache.riven.parser.ExpressionTree;
import org.apache.riven.parser.ExpressionTree.FilterBuilder;
import org.apache.riven.parser.PartFilterExprUtil;
...
import org.apache.riven.utils.Pair;
...
public class ObjectStore implements RawStore, Configurable {
  ...
  */
  ...
  public void setConf(Configuration conf) {
    ...
    try {
      ...
      // using metrics.  But we should always check whether this is non-null before using.
  ...
  public List<String> getAllDatabases() throws MetaException {
    ...
    String queryStr = "select name from org.apache.riven.model.MDatabase";
    Query query = null;
  ...
  private List<MConstraint> listAllTableConstraintsWithOptionalConstraintName
    ...
    try {
      query = pm.newQuery("select constraintName from org.apache.riven.model.MConstraint  where "
  ...
  private Map<String, String> convertMap(Map<String, String> dnMap) {
    return org.apache.riven.utils.MetaStoreUtils.trimMapNulls(dnMap,
  ...
  private MTable convertToMTable(Table tbl) throws InvalidObjectException,
    ...
    return new MTable(StringUtils.normalizeIdentifier(tbl.getTableName()), mdb,
  ...
  private boolean dropPartitionCommon(MPartition part) throws NoSuchObjectException, MetaException,
    ...
    try {
      ...
      if (part != null) {
        ...
        String partName = HdfsUtils.makePartName(colNames, part.getValues());
  ...
  private List<String> getPartitionNamesNoTxn(String dbName, String tableName, short max) {
    ...
    tableName = StringUtils.normalizeIdentifier(tableName);
    Query query =
        pm.newQuery("select partitionName from org.apache.riven.model.MPartition "
  ...
  private Integer getNumPartitionsViaOrmFilter(Table table, ExpressionTree tree, boolean isValidatedFilter)
    ...
    Query query = pm.newQuery(
        "select count(partitionName) from org.apache.riven.model.MPartition"
    );
  ...
  private Pair<Query, Map<String, String>> getPartQueryWithParams(String dbName,
  ...
  public abstract class GetHelper<T> {
    ...
    public GetHelper(String dbName, String tblName, boolean allowSql, boolean allowJdo)
      ...
      this.dbName = StringUtils.normalizeIdentifier(dbName);
      if (tblName != null){
  ...
  public void alterIndex(String dbname, String baseTblName, String name, Index newIndex)
    ...
    try {
      openTransaction();
      name = StringUtils.normalizeIdentifier(name);
      baseTblName = StringUtils.normalizeIdentifier(baseTblName);
      dbname = StringUtils.normalizeIdentifier(dbname);
  ...
  private void addForeignKeys(
    ...
    for (int i = 0; i < fks.size(); i++) {
      final String pkTableDB = StringUtils.normalizeIdentifier(fks.get(i).getPktable_db());
      final String pkTableName = StringUtils.normalizeIdentifier(fks.get(i).getPktable_name());
      final String pkColumnName =StringUtils.normalizeIdentifier(fks.get(i).getPkcolumn_name());
      final String fkTableDB = StringUtils.normalizeIdentifier(fks.get(i).getFktable_db());
      final String fkTableName = StringUtils.normalizeIdentifier(fks.get(i).getFktable_name());
      final String fkColumnName = StringUtils.normalizeIdentifier(fks.get(i).getFkcolumn_name());
      ...
      if (fks.get(i).getFk_name() == null) {
        ...
        currentConstraintName = StringUtils.normalizeIdentifier(fks.get(i).getFk_name());
      }
  ...
  private void addPrimaryKeys(List<SQLPrimaryKey> pks, boolean retrieveCD) throws InvalidObjectException,
    ...
    for (int i = 0; i < pks.size(); i++) {
      final String tableDB = StringUtils.normalizeIdentifier(pks.get(i).getTable_db());
      final String tableName = StringUtils.normalizeIdentifier(pks.get(i).getTable_name());
      final String columnName = StringUtils.normalizeIdentifier(pks.get(i).getColumn_name());
  ...
  private void addUniqueConstraints(List<SQLUniqueConstraint> uks, boolean retrieveCD)
    ...
    for (int i = 0; i < uks.size(); i++) {
      final String tableDB = StringUtils.normalizeIdentifier(uks.get(i).getTable_db());
      final String tableName = StringUtils.normalizeIdentifier(uks.get(i).getTable_name());
      final String columnName = StringUtils.normalizeIdentifier(uks.get(i).getColumn_name());
  ...
  private void addNotNullConstraints(List<SQLNotNullConstraint> nns, boolean retrieveCD)
    ...
    for (int i = 0; i < nns.size(); i++) {
      final String tableDB = StringUtils.normalizeIdentifier(nns.get(i).getTable_db());
      final String tableName = StringUtils.normalizeIdentifier(nns.get(i).getTable_name());
      final String columnName = StringUtils.normalizeIdentifier(nns.get(i).getColumn_name());
  ...
  private MIndex convertToMIndex(Index index) throws InvalidObjectException,
    ...
    return new MIndex(StringUtils.normalizeIdentifier(index.getIndexName()), origTable, index.getCreateTime(),
  ...
  private MIndex getMIndex(String dbName, String originalTblName, String indexName)
    ...
    try {
      openTransaction();
      dbName = StringUtils.normalizeIdentifier(dbName);
      originalTblName = StringUtils.normalizeIdentifier(originalTblName);
      ...
      midx =
          (MIndex) query.execute(originalTblName, dbName,
              StringUtils.normalizeIdentifier(indexName));
      pm.retrieve(midx);
      commited = commitTransaction();
    } finally {
      rollbackAndCleanup(commited, query);
  ...
  public List<Index> getIndexes(String dbName, String origTableName, int max)
    ...
    try {
      ...
      dbName = StringUtils.normalizeIdentifier(dbName);
      origTableName = StringUtils.normalizeIdentifier(origTableName);
      query =
  ...
  public List<String> listIndexNames(String dbName, String origTableName, short max)
    ...
    try {
      ...
      origTableName = StringUtils.normalizeIdentifier(origTableName);
      query =
          pm.newQuery("select indexName from org.apache.riven.model.MIndex "
  ...
  public List<MRoleMap> listMRoles(String principalName,
    ...
    if (principalType == PrincipalType.USER) {
      ...
      MRole publicRole = new MRole(MSConstants.PUBLIC, 0, MSConstants.PUBLIC);
  ...
  public List<String> listRoleNames() {
    ...
    try {
      ...
      query = pm.newQuery("select roleName from org.apache.riven.model.MRole");
  ...
  private <T> List<T> queryByPartitionNames(String dbName, String tableName,
    ...
    Pair<Query, Object[]> queryAndParams = makeQueryByPartitionNames(
  ...
  private Pair<Query, Object[]> makeQueryByPartitionNames(
    ...
    return new Pair<Query, Object[]>(query, params);
  }
  ...
  */
  ...
  protected ColumnStatistics getTableColumnStatisticsInternal(
    ...
    return new GetStatHelper(StringUtils.normalizeIdentifier(dbName),
        StringUtils.normalizeIdentifier(tableName), allowSql, allowJdo) {
      @Override
      ...
      if (colName != null) {
        ...
        mStatsObj =
            (MPartitionColumnStatistics) query.executeWithArray(partName.trim(),
                ...
                StringUtils.normalizeIdentifier(colName));
  ...
  public boolean deleteTableColumnStatistics(String dbName, String tableName, String colName)
    ...
    try {
      ...
      if (colName != null) {
        query.setUnique(true);
        mStatsObj =
            (MTableColumnStatistics) query.execute(StringUtils.normalizeIdentifier(tableName),
                StringUtils.normalizeIdentifier(dbName),
                StringUtils.normalizeIdentifier(colName));
        pm.retrieve(mStatsObj);
  ...
  private synchronized void checkSchema() throws MetaException {
    ...
    boolean strictValidation =
      MetastoreConf.getBoolVar(getConf(), ConfVars.SCHEMA_VERIFICATION);
