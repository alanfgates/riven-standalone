...
import org.apache.riven.impl.AggregateStatsCache.AggrColStats;
...
import org.apache.riven.parser.ExpressionTree.LeafNode;
import org.apache.riven.parser.ExpressionTree.LogicalOperator;
import org.apache.riven.parser.ExpressionTree.Operator;
import org.apache.riven.parser.ExpressionTree.TreeNode;
import org.apache.riven.parser.ExpressionTree.TreeVisitor;
...
public class MetaStoreDirectSql {
  ...
  public MetaStoreDirectSql(PersistenceManager pm, Configuration conf) {
    ...
    convertMapNullsToEmptyStrings =
        MetastoreConf.getBoolVar(conf, MetastoreConf.ConfVars.ORM_RETRIEVE_MAPNULLS_AS_EMPTY_STRINGS);
    defaultPartName = MetastoreConf.getVar(conf, MetastoreConf.ConfVars.DEFAULTPARTITIONNAME);
    ...
    isAggregateStatsCacheEnabled = MetastoreConf.getBoolVar(
        conf, MetastoreConf.ConfVars.AGGREGATE_STATS_CACHE_ENABLED);
      ...
      if (colType == FilterType.Date && valType == FilterType.String) {
        ...
        try {
          nodeValue = new java.sql.Date(
              MSConstants.PARTITION_DATE_FORMAT.get().parse((String)nodeValue).getTime());
